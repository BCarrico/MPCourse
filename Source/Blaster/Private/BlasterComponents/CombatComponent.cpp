...
//TODO: Video 208 = Optional Challenges for Lag Compensation. Client-Side Prediction for Reloading. Set Unoccupied Status Immediately When Reloading. Rockets and Grenades SSR. Change the Hit Target when Confirming a Hit.
...
void UCombatComponent::InterpFOV(float DeltaTime)
{
	...
	{
		CurrentFOV = FMath::FInterpTo(DefaultFOV, CurrentFOV, DeltaTime, ZoomInterpSpeed);
	}
...
void UCombatComponent::InitializeCarriedAmmo()
{
	...
	CarriedAmmoMap.Emplace(EWeaponType::EWT_GrenadeLauncher, StartinGrenadeLauncherAmmo);
}
