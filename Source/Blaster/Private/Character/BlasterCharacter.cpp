...
ABlasterCharacter::ABlasterCharacter()
{
	...
	LagCompensation = CreateDefaultSubobject<ULagCompensationComponent>("LagCompensation"); // Plan to only use on server, does not need to be replicated
