...
USTRUCT(BlueprintType)
struct FShotgunServerSideRewingResult
{
	GENERATED_BODY()
...
protected:
	...
	// HitScan
	FServerSideRewindResult ConfirmedHit(const FFramePackage& Package, ABlasterCharacter* HitCharacter, const FVector_NetQuantize& TraceStart, const FVector_NetQuantize& HitLocation);
	// Projectile
